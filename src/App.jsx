  ...
  return (
    <div style={{ paddingTop:8 }}>
      ...
      <div style={{ background:"#0d1526", border:"1px solid #1e2f4a", borderRadius:16, padding:20 }}>
        ...
        <div style={{ background:"rgba(56,189,248,0.08)", border:"1px solid rgba(56,189,248,0.2)", borderRadius:10, padding:12, fontSize:12, color:"#38bdf8", textAlign:"center", fontWeight:600 }}>📩 eternalep35@gmail.com</div>
      </div>
    </div>
  );
}
